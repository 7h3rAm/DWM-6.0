...
/* tagging */
static const char *tags[] = { "base", "term", "web", "media", "misc", };
...
static const char   *tmuxcmd[] = { "urxvtc", "-title", "tmux", "-e", "tmux", "-f", "/home/theram/.tmux/conf", NULL };
